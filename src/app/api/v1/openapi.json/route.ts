...
const spec = {
  ...
  components: {
    ...
    schemas: {
      ...
      Interaction: {
        type: 'object',
        required: ['id', 'entity_type', 'entity_id', 'note', 'follow_up', 'created_by', 'created_at'],
        properties: {
          id:          { type: 'string', format: 'uuid' },
      ...
      InteractionCreate: {
        ...
        description: 'Required: `entity_type` (`contact` or `company`), `entity_id`, `note`.',
        properties: {
          entity_type: { type: 'string', enum: ['contact', 'company'] },
          entity_id:   { type: 'string', format: 'uuid' },
  ...
  paths: {
    ...
    '/interactions': {
      get: {
        ...
        security: [{ bearerAuth: ['crm:read'] }],
        parameters: [
          { name: 'entity_type', in: 'query', schema: { type: 'string', enum: ['contact', 'company'] } },
